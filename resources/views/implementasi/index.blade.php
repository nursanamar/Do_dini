...
@section('button')
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <form method="POST" action="{{ route('implementasi.delete') }}">
                @csrf
                @method('DELETE')
            ...
            <button class="btn btn-success btn-sm" data-url="hasil-implementasi" id="button-result"><i
                    class="fas fa-poll"></i>
                Uji Hasil</button>
            <!--end::Title-->
        </div>
...
@section('script')
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#button-result', function(e) {
                e.preventDefault();
            ...
            // function fetchData() {
            //     // Tambahkan atribut 'disabled' saat permintaan dimulai
            //     $('#button-result').prop('disabled', true);
            ...
            //                 console.log(
            //                     'Data ditemukan'); // Pesan ini hanya untuk debugging
            //                 // Hapus atribut 'disabled' jika berhasil
            //                 $('#button-result').prop('disabled', false);
            //             }
            //         },
            //         error: function(error) {
            //             console.error(error);
            //             // Hapus atribut 'disabled' jika terjadi kesalahan
            //             $('#button-result').prop('disabled', false);
            //         }
            //     });
            // }
            ...
            $(function() {
                control.initDatatable('/show', columns);
            })
        })
    </script>
@endsection
